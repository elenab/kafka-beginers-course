...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient() {
        // replace with your HOSTED ELASTICSEARCH(bonsai) credentials
        String hostname = System.getenv("HOSTED_ELASTICSEARCH_URL");
        String username = System.getenv("HOSTED_ELASTICSEARCH_NAME");
        String password = System.getenv("HOSTED_ELASTICSEARCH_PASSWORD");
